        ...
        <table class="table border-separate border border-slate-400" id="commoditytable">
                        <thead>
                            <tr class="bg-red-700 dark:bg-dark-1 text-white">
                                <th class="whitespace-no-wrap">Sender</th>
                                <th class="whitespace-no-wrap">Receiver</th>
						...
						@foreach($lotnohistory as $lotnohistory)
                            <tr>
                            <td class="border-b dark:border-dark-5 font-bold">{{ $lotnohistory->issuerlocation }}</td>
                            ...
                            <td class="border-b dark:border-dark-5 font-bold">{{ $lotnohistory->cmsrefnumber }}</td>
                                <td class="border-b dark:border-dark-5">{{ $lotnohistory->lotno }}</td>
                                <td class="border-b dark:border-dark-5 font-bold">{{ $lotnohistory->quantity }}</td>
