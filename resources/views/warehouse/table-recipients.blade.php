...
<div class="content">
        ...
        <table class="table border-separate border border-slate-400" id="recipientstable">
						...
						@foreach($recipients as $recipients)
                            <tr>
                            <td class="border-b dark:border-dark-5 font-bold">{{ $recipients->name }}</td>
                            <td class="border-b dark:border-dark-5 font-bold">{{ $recipients->category }}</td>
                            <td class="border-b dark:border-dark-5 font-bold">{{ $recipients->location }}</td>
                            <td class="border-b dark:border-dark-5 font-bold">{{ $recipients->contactperson }}</td>
                            <td class="border-b dark:border-dark-5 font-bold">{{ $recipients->contactpersonemail }}</td>
                            <td class="border-b dark:border-dark-5 font-bold">{{ $recipients->contactpersonphonenumber }}</td>
                            <td class="border-b dark:border-dark-5 font-bold">{{ $recipients->address }}</td>
                            <td class="border-b dark:border-dark-5 font-bold"><a class="button"  onclick="deleteRecipient('{{ $recipients->contactpersonemail }}')"><i class="fa fa-trash" style="font-size:18px; color: red;"></i></a></td>
                            </tr>
                            @endforeach                            
                        </tbody>
                    </table>                                
